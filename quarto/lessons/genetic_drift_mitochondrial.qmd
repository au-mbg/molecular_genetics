...
def model_plot(p_ooc, child_state, t1, t2, bins, n_samples):
    ...
    # Annotation arrows.
    ax.annotate('Healthy', (0.1, 0.95), (0.7, 0.95), xycoords=(ax.transAxes, ax.transAxes), arrowprops=dict(arrowstyle='->', color='C0', lw=1.5), va='center', ha='center', color='C0', fontsize=12)
